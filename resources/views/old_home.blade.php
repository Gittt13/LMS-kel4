...
<body>
  ...
  <header class="w3-container w3-center"
    style="padding:128px 16px; background-color:#9BBEC8; font-family: 'Poppins', sans-serif;">
    <h1 class="w3-margin w3-jumbo" style="color:#DDF2FD; font-family: 'Poppins', sans-serif;">Learning Management System
    </h1>
    <p class="w3-xlarge" style="color:#427D9D;">dummy</p>
    <button class="w3-button  w3-padding-large w3-large w3-margin-top"
      style="color:#DDF2FD; background-color:#427D9D;"><a href="{{ route('home-student') }}">Get Started</a></button>
  </header>
  ...
  <div class="w3-container w3-center w3-opacity w3-padding-64" style="color:#DDF2FD; background-color:#164863;">
    <h1 class="w3-margin w3-xlarge" style="font-family: 'Poppins', sans-serif;">Quote Of The Day : <br> Tetap bernapas
      dan hidup lah seperti Larry</h1>
  </div>
