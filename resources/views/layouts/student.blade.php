...
<body class="hold-transition sidebar-mini">
    <div class="wrapper " id="app">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="{{ route('home') }}" class="brand-link">
                ...
                <span class="brand-text font-weight-light">{{ Config::get('settings.name') }} <span
                        class="right badge badge-danger">beta</span></span>
            </a>
        ...
        <footer class="main-footer">
            ...
            <!-- Default to the left -->
            <strong>Copyright &copy; {{ \Carbon\Carbon::now()->year }} <a href="http://angelkurten.com">Angel
                    Kürten</a>.</strong> All rights reserved.
        </footer>
    </div>
    <!-- ./wrapper -->
