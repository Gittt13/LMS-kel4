          ...
          <div class="panel-body">
            ...
            <form method="POST" action="{{ route('editform_update',$events->id) }}" enctype="multipart/form-data">
              ...
              <input class="form-control" type="text" name="title" placeholder="Enter The Name"
                value="{{$events->title}}" /><br /><br />
              <label for=""> Enter Color </label>
              <input class="form-control" type="color" name="color" placeholder="Enter The Color"
                value="{{$events->color}}" /><br /><br />

              <label for=""> Enter Start Date Of Event </label>
              <input class="form-control" type="date" name="start_date" class="date" placeholder="Enter Start Date"
                value="{{$events->start_date}}" /><br /><br />

              <label for=""> Enter End Date Of Event </label>
              <input class="form-control" type="date" name="end_date" class="date" placeholder="Enter End Date"
                value="{{$events->end_date}}" /><br /><br />
