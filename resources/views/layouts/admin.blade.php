...
<body class="hold-transition sidebar-mini">
  <div class="wrapper" id="app">
    ...
    <aside class="main-sidebar sidebar-light-warning elevation-4" id="logo">
      <!-- Brand Logo -->
      <a class="brand-link">
        <img src="/img/uni-learn.png" alt="{{ Config::get('settings.name') }}" class="brand-image img-circle elevation-3" style="opacity: .8; background-color: black;">
        <span class="brand-text font-weight-light">{{ Config::get('settings.name') }} 
           <b>Uni-Learn</b>&nbspAdmin
      </a>
      <!-- Sidebar -->
      <div class="sidebar">
